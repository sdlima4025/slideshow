...
const images = [
    { 'id': '1', 'url':'./img/AJUDAS PREGAÇÃO.png' },
    { 'id': '2', 'url':'./img/jw_novoMundo.png' },
    { 'id': '3', 'url':'./img/telasdlima.png' },
    { 'id': '4', 'url':'./img/20201220_174043.jpg' },
    { 'id': '5', 'url':'./img/AJUDAS PREGAÇÃO.png' },
    { 'id': '6', 'url':'./img/jw_novoMundo.png' },
]
